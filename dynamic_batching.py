...
class _Batcher(object):
    ...
    def compute(self, flat_args, output_dtypes):
        return batcher_ops.batcher_compute(self._handle, flat_args,
                                           output_dtypes)
...
def batch_fn_with_options(minimum_batch_size=1,
    ...
    def decorator(f):
        ...
        def wrapper(*args):
            ...
            flat_args = [
                tf.convert_to_tensor(arg) for arg in nest.flatten(args)
            ]
            ...
            if batcher[0] is None:
                ...
                with tf.control_dependencies(None):
                    ...
                    batcher[0] = _Batcher(minimum_batch_size,
                    ...
                    inputs, computation_id = batcher[0].get_inputs(
                        input_dtypes)
                    nest.map_structure(
                    ...
                    set_op = batcher[0].set_outputs(flat_result,
                                                    computation_id)
